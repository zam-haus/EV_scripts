...
12	/070301	Verein – Verbandsmitgliedschaften
23	/070401	Verein – Versicherungen
23	/070501	Verein – Bewirtung Externer
...
234	/080501	Einnahmen – Veranstaltungen – Raumvermietungen
1	/080502	Einnahmen – Veranstaltungen – Eintritte
123	/080599	Einnahmen – Veranstaltungen – Sammel
...
for line in s.split("\n"):
    print(line)
    sphaeren, kstnr, titel = line.split("\t")
    for sp in sphaeren:
        d = {
...
# Billing Accounts
#billing_accounts_eV = ev_client.c.fetch_paginated("https://hexa.easyverein.com/api/v1.7/billing-account")
#billing_accounts_eV_by_number = {d['number']: d for d in billing_accounts_eV}
